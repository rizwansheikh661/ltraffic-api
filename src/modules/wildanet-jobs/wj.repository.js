...
const TABLE = LEGACY.WILDANET;
const DOC_TABLE = LEGACY.W_UPLOAD_DATA;

const COLS = 'id, jobstatus, assignedto, client, authority, community, solonumber, location, postcode, permitstatus, startdate, enddate, notes, image';
...
async function create(fields, conn = pool) {
  const [result] = await conn.query(
    `INSERT INTO ${TABLE}
     ...
     VALUES (:jobstatus, :assignedto, :client, :authority, :community, :solonumber, :location, :postcode, :permitstatus, :startdate, :enddate, :notes, :image)`,
    {
